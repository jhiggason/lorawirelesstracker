...
| 12  | 1    | I/O  | GPIO1, ADC1_CH03, TOUCH1, Read VBAT Voltage. |
...
| Interface              | Type-C USB; 2\*1.25 lithium battery interface; LoRa ANT(IPEX); GNSS ANT(IPEX);2\*18\*2.54 Header Pin |
...
| Mode         | USB powered  | V BAT/battery powered | Unit |
|--------------|--------------|-----------------------|------|
